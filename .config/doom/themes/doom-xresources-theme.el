;;; doom-xresources-theme.el -*- lexical-binding: t; -*-
(require 'doom-themes)
...
(def-doom-theme doom-xresources
  ...
  ((bg         `(,xrbg nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if doom-xresources-brighter-comments dark-cyan base5))
   ...
   (-modeline-bright doom-xresources-brighter-modeline)
   (-modeline-pad
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-xresources-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
